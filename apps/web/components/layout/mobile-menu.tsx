          ...
          >
            ...
            >
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: '4px' }}>
                ...
                {/* Language Toggle */}
                <button
                  onClick={() => {/* Language toggle - future i18n */}}
                  style={{
                    padding: '6px 10px',
                    borderRadius: '9999px',
                    color: '#525252',
                ...
                >
                  <span style={{ color: '#15803d', fontWeight: 700 }}>HR</span>
                ...
                <button
                  onClick={() => {
                    setIsOpen(false);
                    // Small delay to let menu close, then open accessibility
                    setTimeout(() => {
                      const accBtn = document.querySelector('[aria-label="Postavke pristupačnosti"]') as HTMLButtonElement;
                      accBtn?.click();
                    }, 200);
                  }}
                  style={{
